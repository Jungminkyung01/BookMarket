...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300&family=Poor+Story&display=swap" rel="stylesheet">
...
.banner {
	background-image:
		url("https://images.unsplash.com/photo-1444080748397-f442aa95c3e5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1332&q=80");
			...
			<div class="col-lg-12">
				<div class="page-content">
					...
					<div class="row">
						...
						<!-- ***** item_NEW BOOKS ***** -->
						<jsp:include page="products_item02.jsp"></jsp:include>

						<!-- ***** item_NEW BOOKS ***** -->
						<jsp:include page="products_Top02.jsp"></jsp:include>
